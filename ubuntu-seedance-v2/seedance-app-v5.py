...
# Create Gradio 5.x compatible interface
with gr.Blocks(title="Seedance V2 - Video Generation") as demo:
    ...
    with gr.Tab("✍️ Text to Video"):
        with gr.Row():
            ...
            with gr.Column():
                ...
                t2v_status = gr.Textbox(label="Status", lines=8)
    ...
    with gr.Tab("🖼️ Image to Video"):
        with gr.Row():
            ...
            with gr.Column():
                ...
                i2v_status = gr.Textbox(label="Status", lines=8)
    ...
    with gr.Tab("ℹ️ About"):
        ...
        ---
        **Deployed on BytePlus ECS** | **Powered by Seedance API** | **Gradio 5.42**
        """)

if __name__ == "__main__":
    print("🚀 Starting Seedance V2 Application (Gradio 5.42)...")
    ...
    # Gradio 5.x compatible launch (removed deprecated parameters)
    demo.launch(
        server_name="0.0.0.0",
        server_port=7860,
        share=False
